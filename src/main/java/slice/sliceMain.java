...
//		String descriptor = "([Ljava/lang/String;)V"; //I don't use this descriptor
		Iterable<Entrypoint> entrypoints = sUtil.makeMethodEntrypoints(scope.getApplicationLoader(), cha, methodName);
		//4. analysis options
		AnalysisOptions options = new AnalysisOptions(scope, entrypoints);
		//5. Build the call graph
		CallGraphBuilder<?> builder = Util.makeZeroCFABuilder(JavaLanguage.JAVA,options, new AnalysisCacheImpl(),cha, scope, null, null);
